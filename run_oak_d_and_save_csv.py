...
# field names
fields = ['timestamp', 'photo_name', 'class_name','x_cord', 'y_cord', 'width', 'height'] 
...
with open(csv_filename, 'w') as csvfile: 
    ...
    if __name__ == '__main__':
        ...
        version="1", api_key="zByfy0GB9wFAa7p8DVFo", rgb=True,
        ...
        while True:
            ...
            for p in predictions:
                    ...
                    # Dictionary
                    dict = {"timestamp":str(local_time), "photo_name":str(filename), "class_name":str(class_name), "x_cord":str(x_cord),"y_cord":str(y_cord), "width":str(width), "height":str(height)}
